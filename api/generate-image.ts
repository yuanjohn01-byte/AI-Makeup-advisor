...
export default async function handler(req: any, res: any) {
  console.log("Generate Image API triggered");
  ...
  if (!userImageBase64 || !styleImageBase64) {
    console.error("Missing userImageBase64 or styleImageBase64 in request body");
  ...
  try {
    ...
    // Reverting to the original image model name
    ...
    console.error("No image part found in the model response candidates");
